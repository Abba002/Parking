...
HD_PWD='C:/Abba/Parking/parking.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log parkingsystem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source parkingsystem.tcl

...
HD_PWD='C:/Abba/Parking/parking.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log parkingsystem.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source parkingsystem.tcl -notrace
